...
class InGameClient : public NCL::CSC8503::PushdownState
{
public:
	InGameClient(NCL::CSC8503::GameWorld* world, NCL::CSC8503::PhysicsSystem* physics, NCL::CSC8503::GameTechRenderer* renderer,
